...
class ChartGenerationTool(BaseTool):
    name = "chart_generation_tool"
    description = "Generates charts using matplotlib based on provided Python code"
    ...
    def _run(self, python_code: str) -> str:
        ...
        try:
            ...
            if plt.get_fignums():
                ...
                raise Exception("No plot was generated by the code")
...
class ChartGenerationService:
    def __init__(self):
        ...
        self.visualization_agent = Agent(
            ...
            goal="Create informative and visually appealing charts using matplotlib",
            backstory="You are an expert in data visualization with deep knowledge of matplotlib and pandas. Your specialty is creating clear, informative charts for sports analytics.",
            tools=[self.chart_tool],
            allow_code_execution=True
        )

    async def generate_chart(self, python_code: str) -> str:
        chart_task = Task(
            description="Generate a chart using the provided Python code",
            agent=self.visualization_agent,
            context={"python_code": python_code}
        )
        
        chart_crew = Crew(
            agents=[self.visualization_agent],
            tasks=[chart_task]
        )
        
        try:
            result = await chart_crew.kickoff()
            return result
        except Exception as e:
